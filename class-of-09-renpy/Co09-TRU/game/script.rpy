...
label scene_0003:
    ...
    $ speak(JECKA, "Oh okay. You think they have MSI stuff here?")
    $ setWait(15.807,16.641)
    $ speak(NICOLE, "The band?")
    show jecka sc1 smile:
        rightcenterstage
    $ setWait(16.641,20.27)
    $ speak(JECKA, "Yeah they're all in my shuffle and they might be in town this Saturday.")
